...
var m = "11.5.0";
var A = new Logger("@firebase/firestore");
...
var P = "cancelled";
var R = "unknown";
var I = "invalid-argument";
var V = "deadline-exceeded";
var p = "not-found";
var y = "already-exists";
var w = "permission-denied";
var g = "unauthenticated";
var F = "resource-exhausted";
var v = "failed-precondition";
var D = "aborted";
var b = "out-of-range";
var C = "unimplemented";
var S = "internal";
...
var __PRIVATE_LiteAppCheckTokenProvider = class {
  constructor(e, r) {
    this.h = r, this.appCheck = null, this.m = null, _isFirebaseServerApp(e) && e.settings.appCheckToken && (this.m = e.settings.appCheckToken), r.onInit((t) => {
      this.appCheck = t;
    });
  }
  getToken() {
    return this.m ? Promise.resolve(new AppCheckToken(this.m)) : this.appCheck ? this.appCheck.getToken().then((t) => t ? (__PRIVATE_hardAssert("string" == typeof t.token), new AppCheckToken(t.token)) : null) : Promise.resolve(null);
  }
  invalidateToken() {
  }
  start(t, e) {
  ...
  static fromServerFormat(t) {
    ...
    for (; n < t.length; ) {
      ...
      if ("\\" === e2) {
        ...
        const e3 = t[n + 1];
        if ("\\" !== e3 && "." !== e3 && "`" !== e3) throw new FirestoreError(I, "Path has invalid escape sequence: " + t);
        r += e3, n += 2;
...
var __PRIVATE_RestConnection = class {
  ...
  I(t, e, r, n, i) {
    ...
    return this.p(a, n, i), this.F(t, o, a, r).then((e2) => (__PRIVATE_logDebug(L, `Received RPC '${t}' ${s}: `, e2), e2), (e2) => {
      throw __PRIVATE_logWarn(L, `RPC '${t}' ${s} failed with error: `, e2, "url: ", o, "request:", r), e2;
    });
  }
  v(t, e, r, n, i, s) {
...
function __PRIVATE_mapCodeFromHttpStatus(t) {
  if (void 0 === t) return __PRIVATE_logError("RPC_ERROR", "HTTP error has no status"), R;
  switch (t) {
    case 200:
      return T;
    case 400:
...
(x = U || (U = {}))[x.OK = 0] = "OK", x[x.CANCELLED = 1] = "CANCELLED", x[x.UNKNOWN = 2] = "UNKNOWN", x[x.INVALID_ARGUMENT = 3] = "INVALID_ARGUMENT", x[x.DEADLINE_EXCEEDED = 4] = "DEADLINE_EXCEEDED", x[x.NOT_FOUND = 5] = "NOT_FOUND", x[x.ALREADY_EXISTS = 6] = "ALREADY_EXISTS", x[x.PERMISSION_DENIED = 7] = "PERMISSION_DENIED", x[x.UNAUTHENTICATED = 16] = "UNAUTHENTICATED", x[x.RESOURCE_EXHAUSTED = 8] = "RESOURCE_EXHAUSTED", x[x.FAILED_PRECONDITION = 9] = "FAILED_PRECONDITION", x[x.ABORTED = 10] = "ABORTED", x[x.OUT_OF_RANGE = 11] = "OUT_OF_RANGE", x[x.UNIMPLEMENTED = 12] = "UNIMPLEMENTED", x[x.INTERNAL = 13] = "INTERNAL", x[x.UNAVAILABLE = 14] = "UNAVAILABLE", x[x.DATA_LOSS = 15] = "DATA_LOSS";
...
var k = new RegExp(/^\d{4}-\d\d-\d\dT\d\d:\d\d:\d\d(?:\.(\d+))?Z$/);
...
function __PRIVATE_typeOrder(t) {
  return "nullValue" in t ? 0 : "booleanValue" in t ? 1 : "integerValue" in t || "doubleValue" in t ? 2 : "timestampValue" in t ? 3 : "stringValue" in t ? 5 : "bytesValue" in t ? 6 : "referenceValue" in t ? 7 : "geoPointValue" in t ? 8 : "arrayValue" in t ? 9 : "mapValue" in t ? __PRIVATE_isServerTimestamp(t) ? 4 : (
    ...
    function __PRIVATE_isMaxValue(t2) {
      return (((t2.mapValue || {}).fields || {}).__type__ || {}).stringValue === K;
    }(t) ? 9007199254740991 : (
      /** Returns true if `value` is a VetorValue. */
      function __PRIVATE_isVectorValue(t2) {
        var e, r;
        const n = null === (r = ((null === (e = null == t2 ? void 0 : t2.mapValue) || void 0 === e ? void 0 : e.fields) || {})[W]) || void 0 === r ? void 0 : r.stringValue;
        return n === H;
      }(t) ? 10 : 11
    )
  ) : fail();
  ...
  switch (r) {
    ...
    case 10:
      return function __PRIVATE_compareVectors(t2, e2) {
        var r2, n2, i, s;
        const o = t2.fields || {}, a = e2.fields || {}, u = null === (r2 = o[J]) || void 0 === r2 ? void 0 : r2.arrayValue, _ = null === (n2 = a[J]) || void 0 === n2 ? void 0 : n2.arrayValue, c = __PRIVATE_primitiveComparator((null === (i = null == u ? void 0 : u.values) || void 0 === i ? void 0 : i.length) || 0, (null === (s = null == _ ? void 0 : _.values) || void 0 === s ? void 0 : s.length) || 0);
        if (0 !== c) return c;
        return __PRIVATE_compareArrays(u, _);
      }(t.mapValue, e.mapValue);
    case 11:
      return function __PRIVATE_compareMaps(t2, e2) {
        if (t2 === G && e2 === G) return 0;
        if (t2 === G) return 1;
        if (e2 === G) return -1;
...
var CompositeFilter = class _CompositeFilter extends Filter {
  ...
  getFlattenedFilters() {
    return null !== this.C || (this.C = this.filters.reduce((t, e) => t.concat(e.getFlattenedFilters()), [])), this.C;
  }
...
var __PRIVATE_TargetImpl = class {
  constructor(t, e = null, r = [], n = [], i = null, s = null, o = null) {
    this.path = t, this.collectionGroup = e, this.orderBy = r, this.filters = n, this.limit = i, this.startAt = s, this.endAt = o, this.S = null;
  }
};
...
var __PRIVATE_QueryImpl = class {
  ...
  constructor(t, e = null, r = [], n = [], i = null, s = "F", o = null, a = null) {
    this.path = t, this.collectionGroup = e, this.explicitOrderBy = r, this.filters = n, this.limit = i, this.limitType = s, this.startAt = o, this.endAt = a, this.N = null, // The corresponding `Target` of this `Query` instance, for use with
    // non-aggregate queries.
    this.O = null, // The corresponding `Target` of this `Query` instance, for use with
...
function __PRIVATE_queryNormalizedOrderBy(t) {
  ...
  if (null === e.N) {
    ...
    for (const r2 of e.explicitOrderBy) e.N.push(r2), t2.add(r2.field.canonicalString());
    ...
    n.forEach((n2) => {
      t2.has(n2.canonicalString()) || n2.isKeyField() || e.N.push(new OrderBy(n2, r));
    }), // Add the document key field to the last if it is not explicitly ordered.
    t2.has(FieldPath$1.keyField().canonicalString()) || e.N.push(new OrderBy(FieldPath$1.keyField(), r));
  }
  return e.N;
}
function __PRIVATE_queryToTarget(t) {
  const e = __PRIVATE_debugCast(t);
  return e.O || (e.O = __PRIVATE__queryToTarget(e, __PRIVATE_queryNormalizedOrderBy(t))), e.O;
}
...
var __PRIVATE_ExponentialBackoff = class {
  constructor(t, e, r = 1e3, n = 1.5, i = 6e4) {
    this.L = t, this.timerId = e, this.M = r, this.U = n, this.k = i, this.j = 0, this.W = null, /** The last backoff attempt, as epoch milliseconds. */
  ...
  H(t) {
    ...
    n > 0 && __PRIVATE_logDebug("ExponentialBackoff", `Backing off for ${n} ms (base delay: ${this.j} ms, delay with jitter: ${e} ms, last attempt: ${r} ms ago)`), this.W = this.L.enqueueAfterDelay(this.timerId, n, () => (this.K = Date.now(), t())), // Apply backoff factor to determine next delay and ensure it is within
    // bounds.
...
var __PRIVATE_DatastoreImpl = class extends Datastore {
  constructor(t, e, r, n) {
    super(), this.authCredentials = t, this.appCheckCredentials = e, this.connection = r, this.serializer = n, this.Z = false;
  }
  X() {
  ...
  I(t, e, r, n) {
    return this.X(), Promise.all([this.authCredentials.getToken(), this.appCheckCredentials.getToken()]).then(([i, s]) => this.connection.I(t, __PRIVATE_toResourcePath(e, r), n, i, s)).catch((t2) => {
      throw "FirebaseError" === t2.name ? (t2.code === g && (this.authCredentials.invalidateToken(), this.appCheckCredentials.invalidateToken()), t2) : new FirestoreError(R, t2.toString());
    });
  }
  /** Invokes the provided RPC with streamed results with auth and AppCheck tokens. */
  v(t, e, r, n, i) {
    return this.X(), Promise.all([this.authCredentials.getToken(), this.appCheckCredentials.getToken()]).then(([s, o]) => this.connection.v(t, __PRIVATE_toResourcePath(e, r), n, s, o, i)).catch((t2) => {
      throw "FirebaseError" === t2.name ? (t2.code === g && (this.authCredentials.invalidateToken(), this.appCheckCredentials.invalidateToken()), t2) : new FirestoreError(R, t2.toString());
    });
  }
  terminate() {
...
async function __PRIVATE_invokeBatchGetDocumentsRpc(t, e) {
  ...
  }, i = await r.v("BatchGetDocuments", r.serializer.databaseId, ResourcePath.emptyPath(), n, e.length), s = /* @__PURE__ */ new Map();
  i.forEach((t2) => {
...
async function __PRIVATE_invokeRunAggregationQueryRpc(t, e, r) {
  var n;
  const i = __PRIVATE_debugCast(t), { request: s, tt: o, parent: a } = function __PRIVATE_toRunAggregationQueryRequest(t2, e2, r2, n2) {
    const { $: i2, parent: s2 } = __PRIVATE_toQueryTarget(t2, e2), o2 = {}, a2 = [];
    let u2 = 0;
    ...
    return e2.q || // Do not include implicit order-bys for aggregate queries.
    (e2.q = __PRIVATE__queryToTarget(e2, t2.explicitOrderBy)), e2.q;
  }(e), r);
...
var rt = 1048576;
var nt = "firestore.googleapis.com";
var it = true;
var FirestoreSettingsImpl = class {
  constructor(t) {
    ...
    !function __PRIVATE_validateIsNotUsedTogether(t2, e2, r2, n) {
      if (true === e2 && true === n) throw new FirestoreError(I, `${t2} and ${r2} cannot be used together.`);
      ...
      if (void 0 !== t2.timeoutSeconds) {
        if (isNaN(t2.timeoutSeconds)) throw new FirestoreError(I, `invalid long polling timeout: ${t2.timeoutSeconds} (must not be NaN)`);
        if (t2.timeoutSeconds < 5) throw new FirestoreError(I, `invalid long polling timeout: ${t2.timeoutSeconds} (minimum allowed value is 5)`);
        if (t2.timeoutSeconds > 30) throw new FirestoreError(I, `invalid long polling timeout: ${t2.timeoutSeconds} (maximum allowed value is 30)`);
      }
...
function connectFirestoreEmulator(t, e, r, n = {}) {
  ...
  if (!deepEqual(u, o) && (t._setSettings(u), n.mockUserToken)) {
    ...
    if ("string" == typeof n.mockUserToken) e2 = n.mockUserToken, r2 = User.MOCK_USER;
      ...
      if (!s2) throw new FirestoreError(I, "mockUserToken must contain 'sub' or 'user_id' field!");
      r2 = new User(s2);
    }
...
function collectionGroup(t, e) {
  if (t = __PRIVATE_cast(t, Firestore), __PRIVATE_validateNonEmptyArgument("collectionGroup", "collection id", e), e.indexOf("/") >= 0) throw new FirestoreError(I, `Invalid collection ID '${e}' passed to function collectionGroup(). Collection IDs must not contain '/'.`);
  return new Query(
    t,
    /* converter= */
    null,
...
var Bytes = class _Bytes {
  ...
  static fromBase64String(t) {
    try {
      ...
      throw new FirestoreError(I, "Failed to construct data from Base64 string: " + t2);
    }
  }
  /**
...
function __PRIVATE_parseSetData(t, e, r, n, i, s = {}) {
  const o = t.dt(s.merge || s.mergeFields ? 2 : 0, e, r, i);
  ...
  if (s.merge) u = new FieldMask(o.fieldMask), _ = o.fieldTransforms;
    ...
    for (const n2 of s.mergeFields) {
      ...
      if (!o.contains(i2)) throw new FirestoreError(I, `Field '${i2}' is specified in your field mask but missing from your input data.`);
...
var __PRIVATE_DeleteFieldValueImpl = class ___PRIVATE_DeleteFieldValueImpl extends FieldValue {
  _toFieldTransform(t) {
    if (2 !== t.rt) throw 1 === t.rt ? t.ct(`${this._methodName}() can only appear at the top level of your update data`) : t.ct(`${this._methodName}() cannot be used with set() unless you pass {merge:true}`);
...
var __PRIVATE_ArrayUnionFieldValueImpl = class ___PRIVATE_ArrayUnionFieldValueImpl extends FieldValue {
  ...
  _toFieldTransform(t) {
    const e = __PRIVATE_createSentinelChildContext(
      ...
      /*array=*/
      true
    ), r = this.ft.map((t2) => __PRIVATE_parseData(t2, e)), n = new __PRIVATE_ArrayUnionTransformOperation(r);
    return new FieldTransform(t.path, n);
  }
  isEqual(t) {
    return t instanceof ___PRIVATE_ArrayUnionFieldValueImpl && deepEqual(this.ft, t.ft);
  }
};
var __PRIVATE_ArrayRemoveFieldValueImpl = class ___PRIVATE_ArrayRemoveFieldValueImpl extends FieldValue {
  ...
  _toFieldTransform(t) {
    const e = __PRIVATE_createSentinelChildContext(
      ...
      /*array=*/
      true
    ), r = this.ft.map((t2) => __PRIVATE_parseData(t2, e)), n = new __PRIVATE_ArrayRemoveTransformOperation(r);
    return new FieldTransform(t.path, n);
  }
  isEqual(t) {
    return t instanceof ___PRIVATE_ArrayRemoveFieldValueImpl && deepEqual(this.ft, t.ft);
  }
};
var __PRIVATE_NumericIncrementFieldValueImpl = class ___PRIVATE_NumericIncrementFieldValueImpl extends FieldValue {
  ...
  isEqual(t) {
    return t instanceof ___PRIVATE_NumericIncrementFieldValueImpl && this.Et === t.Et;
  }
};
...
function __PRIVATE_parseUpdateVarargs(t, e, r, n, i, s) {
  const o = t.dt(1, e, r), a = [__PRIVATE_fieldPathFromArgument$1(e, n, r)], u = [i];
...
function __PRIVATE_parseQueryValue(t, e, r, n = false) {
  return __PRIVATE_parseData(r, t.dt(n ? 4 : 3, e));
}
function __PRIVATE_parseData(t, e) {
  ...
  if (t instanceof FieldValue)
    return function __PRIVATE_parseSentinelFieldValue(t2, e2) {
      if (!__PRIVATE_isWrite(e2.rt)) throw e2.ct(`${t2._methodName}() can only be used with update() and set()`);
      if (!e2.path) throw e2.ct(`${t2._methodName}() is not currently supported inside arrays`);
  ...
  if (
    ...
    if (e.settings.st && 4 !== e.rt) throw e.ct("Nested arrays are not supported");
    return function __PRIVATE_parseArray(t2, e2) {
      const r = [];
      let n = 0;
      for (const i of t2) {
        let t3 = __PRIVATE_parseData(i, e2._t(n));
  ...
  return function __PRIVATE_parseScalarValue(t2, e2) {
    ...
    if (t2 instanceof DocumentReference) {
      ...
      if (!n.isEqual(r)) throw e2.ct(`Document reference is for database ${n.projectId}/${n.database} but should be for database ${r.projectId}/${r.database}`);
      return {
            ...
            [J]: {
              arrayValue: {
                values: t3.toArray().map((t4) => {
                  if ("number" != typeof t4) throw e3.ct("VectorValues must only contain numeric values.");
    ...
    throw e2.ct(`Unsupported field value: ${__PRIVATE_valueDescription(t2)}`);
  }(t, e);
}
function __PRIVATE_parseObject(t, e) {
  ...
  return !function isEmpty(t2) {
    ...
    const i = __PRIVATE_parseData(n, e.it(t2));
    null != i && (r[t2] = i);
  }) : (
...
function __PRIVATE_fieldPathFromDotSeparatedString(t, e, r) {
  if (e.search(ot) >= 0) throw __PRIVATE_createError(
...
function __PRIVATE_createError(t, e, r, n, i) {
  ...
  let u = "";
  return (s || o) && (u += " (found", s && (u += ` in field ${n}`), o && (u += ` in document ${i}`), u += ")"), new FirestoreError(I, a + t + u);
}
...
function query(t, e, ...r) {
  ...
  e instanceof AppliableConstraint && n.push(e), n = n.concat(r), function __PRIVATE_validateQueryConstraintArray(t2) {
    ...
    if (e2 > 1 || e2 > 0 && r2 > 0) throw new FirestoreError(I, "InvalidQuery. When using composite filters, you cannot use more than one filter at the top level. Consider nesting the multiple filters within an `and(...)` statement. For example: change `query(query, where(...), or(...))` to `query(query, and(where(...), or(...)))`.");
  }(n);
...
var QueryFieldFilterConstraint = class _QueryFieldFilterConstraint extends QueryConstraint {
  ...
  _parse(t) {
    const e = __PRIVATE_newUserDataReader(t.firestore), r = function __PRIVATE_newQueryFilter(t2, e2, r2, n, i, s, o) {
      let a;
      if (i.isKeyField()) {
        if ("array-contains" === s || "array-contains-any" === s) throw new FirestoreError(I, `Invalid Query. You can't perform '${s}' queries on documentId().`);
        if ("in" === s || "not-in" === s) {
...
var QueryOrderByConstraint = class _QueryOrderByConstraint extends QueryConstraint {
  ...
  _apply(t) {
    const e = function __PRIVATE_newQueryOrderBy(t2, e2, r) {
      if (null !== t2.startAt) throw new FirestoreError(I, "Invalid query. You must not call startAt() or startAfter() before calling orderBy().");
      if (null !== t2.endAt) throw new FirestoreError(I, "Invalid query. You must not call endAt() or endBefore() before calling orderBy().");
...
function __PRIVATE_newQueryBoundFromDocOrFields(t, e, r, n) {
  if (r[0] = getModularInstance(r[0]), r[0] instanceof DocumentSnapshot) return function __PRIVATE_newQueryBoundFromDocument(t2, e2, r2, n2, i) {
    ...
    for (const r3 of __PRIVATE_queryNormalizedOrderBy(t2)) if (r3.field.isKeyField()) s.push(__PRIVATE_refValue(e2, n2.key));
      ...
      if (__PRIVATE_isServerTimestamp(t3)) throw new FirestoreError(I, 'Invalid query. You are trying to start or end a query using a document for which the field "' + r3.field + '" is an uncommitted server timestamp. (Since the value of this field is unknown, you cannot start/end a query with it.)');
      if (null === t3) {
        const t4 = r3.field.canonicalString();
        throw new FirestoreError(I, `Invalid query. You are trying to start or end a query using a document for which the field '${t4}' (used as the orderBy) does not exist.`);
      }
      s.push(t3);
    }
  ...
  }(t._query, t.firestore._databaseId, e, r[0]._document, n);
  {
    ...
    return function __PRIVATE_newQueryBoundFromFields(t2, e2, r2, n2, i2, s) {
      ...
      if (i2.length > o.length) throw new FirestoreError(I, `Too many arguments provided to ${n2}(). The number of arguments must be less than or equal to the number of orderBy() clauses`);
      const a = [];
      for (let s2 = 0; s2 < i2.length; s2++) {
        const u = i2[s2];
        if (o[s2].field.isKeyField()) {
          if ("string" != typeof u) throw new FirestoreError(I, `Invalid query. Expected a string for document ID in ${n2}(), but got a ${typeof u}`);
          if (!__PRIVATE_isCollectionGroupQuery(t2) && -1 !== u.indexOf("/")) throw new FirestoreError(I, `Invalid query. When querying a collection and ordering by documentId(), the value passed to ${n2}() must be a plain document ID, but '${u}' contains a slash.`);
          const r3 = t2.path.child(ResourcePath.fromString(u));
          if (!DocumentKey.isDocumentKey(r3)) throw new FirestoreError(I, `Invalid query. When querying a collection group and ordering by documentId(), the value passed to ${n2}() must result in a valid document path, but '${r3}' is not because it contains an odd number of segments.`);
...
var AbstractUserDataWriter = class {
  ...
  convertVectorValue(t) {
    var e, r, n;
    const i = null === (n = null === (r = null === (e = t.fields) || void 0 === e ? void 0 : e[J].arrayValue) || void 0 === r ? void 0 : r.values) || void 0 === n ? void 0 : n.map((t2) => __PRIVATE_normalizeNumber(t2.doubleValue));
...
function getDocs(t) {
  (function __PRIVATE_validateHasExplicitOrderByForLimitToLast(t2) {
    if ("L" === t2.limitType && 0 === t2.explicitOrderBy.length) throw new FirestoreError(C, "limitToLast() queries require specifying at least one orderBy() clause");
...
function __PRIVATE_validateReference(t, e) {
  if ((t = getModularInstance(t)).firestore !== e) throw new FirestoreError(I, "Provided document reference is from a different Firestore instance.");
  return t;
}
...
var Transaction$1 = class {
  ...
  async lookup(t) {
    if (this.ensureCommitNotCalled(), this.mutations.length > 0) throw this.lastTransactionError = new FirestoreError(I, "Firestore transactions require all reads to be executed before all writes."), this.lastTransactionError;
...
var __PRIVATE_TransactionRunner = class {
  constructor(t, e, r, n, i) {
    this.asyncQueue = t, this.datastore = e, this.options = r, this.updateFunction = n, this.deferred = i, this.At = r.maxAttempts, this.Tt = new __PRIVATE_ExponentialBackoff(
      this.asyncQueue,
      "transaction_retry"
  ...
  Vt(t) {
    this.At > 0 && this.yt(t) ? (this.At -= 1, this.asyncQueue.enqueueAndForget(() => (this.Rt(), Promise.resolve()))) : this.deferred.reject(t);
  }
  yt(t) {
...
var __PRIVATE_AsyncQueueImpl = class {
  constructor(t = Promise.resolve()) {
    ...
    this.Tt = new __PRIVATE_ExponentialBackoff(
      this,
      "async_queue_retry"
    ...
    this.St = () => {
      ...
      t2 && __PRIVATE_logDebug(ut, "Visibility state changed to " + t2.visibilityState), this.Tt.Y();
    }, this.Nt = t;
    const e = getDocument();
  ...
  enqueueAndForgetEvenWhileRestricted(t) {
    this.Ot(), // eslint-disable-next-line @typescript-eslint/no-floating-promises
    this.qt(t);
  }
  ...
  enqueue(t) {
    ...
    return this.qt(() => this.gt && this.bt ? Promise.resolve() : (t().then(e.resolve, e.reject), e.promise)).then(() => e.promise);
  }
  enqueueRetryable(t) {
  ...
  qt(t) {
    const e = this.Nt.then(() => (this.Dt = true, t().catch((t2) => {
  ...
  enqueueAfterDelay(t, e, r) {
    this.Ot(), // Fast-forward delays for timerIds that have been overridden.
    this.Ct.indexOf(t) > -1 && (e = 0);
    const n = DelayedOperation.createAndSchedule(this, t, e, r, (t2) => this.$t(t2));
...
function runTransaction(t, e, r) {
  ...
  !function __PRIVATE_validateTransactionOptions(t2) {
    if (t2.maxAttempts < 1) throw new FirestoreError(I, "Max attempts must be at least 1");
  }(i);
  ...
  }(), n, i, (r2) => e(new Transaction(t, r2)), s).Pt(), s.promise;
}
!function __PRIVATE_registerFirestore() {
  !function __PRIVATE_setSDKVersion(t) {
    ...
    const n = t.getProvider("app").getImmediate(), i = new Firestore(new __PRIVATE_LiteAuthCredentialsProvider(t.getProvider("auth-internal")), new __PRIVATE_LiteAppCheckTokenProvider(n, t.getProvider("app-check-internal")), function __PRIVATE_databaseIdFromApp(t2, e2) {
      if (!Object.prototype.hasOwnProperty.apply(t2.options, ["projectId"])) throw new FirestoreError(I, '"projectId" not provided in firebase.initializeApp.');
  ...
  registerVersion("firestore-lite", E, ""), registerVersion("firestore-lite", E, "esm2017");
}();
export {
  AggregateField,
